Recipes.create( { name: "soup coriander", content: "  1 tablespoon kosher salt, plus more to taste
											...
											Place chicken pieces in a separate bowl and add 1/2 of the spice blend. Mix together thoroughly 
											to coat each surface with spice blend.
											Heat oil over high heat in a heavy pot. Brown half of the chicken pieces on all sides. Transfer 
											to a bowl. Repeat with the rest of the chicken.
											...
											Transfer zucchini, red bell pepper, poblano pepper, and peanuts to the pot. Stir to mix. Continue simmering until chicken and vegetables are fork tender, 30 to 40 minutes. Remove from heat.", image_url: "http://images.media-allrecipes.com/userphotos/720x405/2610565.jpg" } )
Recipes.create( { name: "Roasted sweet potato & carrot soup", content: "500g sweet potatoes
...
Once the roasted veg is done, leave to cool a little, then transfer to the saucepan and use a hand blender to process until smooth. Stir in the crème fraîche, a little more seasoning and reheat until hot. Serve in bowls topped with a swirl of crème fraîche and a good grinding of black pepper.", image_url: "http://images.dinosaurpictures.org.rsz.io/nyito_4f23.jpg" } )




Recipes.create( { name: " Roasted brassicas with puy lentils & halloumi", content: "800g  broccoli and cauliflower
olive oil
...
Drizzle over the honey and fry for 1 more minute, until sticky and caramelised. Scatter the halloumi over the salad and serve immediately.", image_url: "http://cdn.jamieoliver.com/recipe-database/430_575/EapG3Zqx4p19KmBDNvvdak.jpg" } )
Recipes.create( { name: "Mainely Fish", content: " 6 (3 ounce) fillets haddock
...
", image_url: "http://images.media-allrecipes.com/userphotos/720x405/974614.jpg" } )


Recipes.create( { name: "Too Much Chocolate Cake", content: " 1 (18.25 ounce) package devil's food cake mix
...
", image_url: "http://images.media-allrecipes.com/userphotos/720x405/1130307.jpg" } )
Recipes.create( { name: "Lemon Ricotta Pancakes with Blueberry Sauce", content:"    2 tablespoons lemon juice
...
", image_url: "http://images.media-allrecipes.com/userphotos/720x405/1538703.jpg" } )